...
TCL_CC='/tmp/build/80754af9/tk_1592503156360/_build_env/bin/x86_64-conda_cos6-linux-gnu-cc'
...
# installed.
TCL_PREFIX='/root/data/miniconda3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/root/data/miniconda3'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /root/data/miniconda3/include -fdebug-prefix-map=/tmp/build/80754af9/tk_1592503156360/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/root/data/miniconda3=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /root/data/miniconda3/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/root/data/miniconda3/lib -Wl,-rpath-link,/root/data/miniconda3/lib -L/root/data/miniconda3/lib -Wl,--export-dynamic '
...
TCL_RANLIB='/tmp/build/80754af9/tk_1592503156360/_build_env/bin/x86_64-conda_cos6-linux-gnu-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/tmp/build/80754af9/tk_1592503156360/work/tcl8.6.10/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/root/data/miniconda3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/root/data/miniconda3/include'
...
# compiled.
TCL_SRC_DIR='/tmp/build/80754af9/tk_1592503156360/work/tcl8.6.10'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/root/data/miniconda3/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/tmp/build/80754af9/tk_1592503156360/work/tcl8.6.10/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/root/data/miniconda3/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1592503156360/work/tcl8.6.10/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/root/data/miniconda3/lib/libtclstub8.6.a'
