...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': ' '
              'x86_64-conda-linux-gnu-gcc -pthread -shared -Wl,-O2 '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': ' '
       'x86_64-conda-linux-gnu-gcc -pthread',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--prefix=/root/data/miniconda3' "
                ...
                "'CC= "
                "x86_64-conda-linux-gnu-gcc' 'CFLAGS=-march=nocona "
                ...
                '/root/data/miniconda3/include '
                "-I/root/data/miniconda3/include' "
                "'CPP=/home/builder/ktietz/cos6/ci_cos6/python-split_1622827272909/_build_env/bin/x86_64-conda-linux-gnu-cpp' "
